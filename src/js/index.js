...
(function () {
  ...
  var imgLeft = modal.querySelector('.control-left')
  var imgRight = modal.querySelector('.control-right')
  ...
  var navLinks = navbar.querySelectorAll('.main-nav .nav-item')
  ...
  var playbtn = playlist.querySelector('.playlist-btn')
  var playlistClose = playlist.querySelector('.playlist-close')
